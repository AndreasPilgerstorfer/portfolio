...
const About = () => {
    return (
        <div className="mb-10">
            ...
            >
                <div className="rounded-lg md:col-span-5 about__image-container">
                ...
                <div className="rounded-lg md:col-span-7 about__image-container">
                ...
                <div className="bg-black-100 rounded-lg p-4 md:col-span-4">
                ...
                <div className="rounded-lg md:col-span-4 about__image-container">
                ...
                <a href="https://github.com/AndreasPilgerstorfer"
                   target="_blank" rel="noopener"
                ...
                <a href="https://www.youtube.com/watch?v=vqFaMSXxhmo"
                ...
                <a href="https://tractive.com/blog/en/life-at-tractive/tractive-honeypots"
                   className="rounded-lg md:col-span-6 about__image-container"
                   target="_blank" rel="noopener">
                ...
                <a href="http://www.kollektiv-salzstrasse.at/" target="_blank" rel="noopener"
